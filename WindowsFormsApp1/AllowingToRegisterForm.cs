...
namespace WindowsFormsApp1
{
    public partial class AllowingToRegisterForm : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int _Admin = (int)((Math.Pow(firstPIN - 7, 2) - 49) * (Math.Pow(firstPIN - 7, 2) - 36));// (x+7)(x-7)(x-6)(x+6)
            int _Candidate = (int)((Math.Pow(firstPIN + 5, 2) - 25) * (Math.Pow(firstPIN + 5, 2) - 16));// (x-5)(x+5)(x-4)(x+4)
            int _Voter = (int)((Math.Pow(firstPIN + 3, 2) - 9) * (Math.Pow(firstPIN + 3, 2) - 4));// (x-3)(x+3)(x+2)(x-2)
